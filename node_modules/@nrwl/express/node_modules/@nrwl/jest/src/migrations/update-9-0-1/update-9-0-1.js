...
const addPassWithNoTestsToWorkspace = (0, workspace_2.updateWorkspace)((workspace) => {
...
function removePassWithNoTestsFromJestConfig(host) {
    if (host.exists('jest.config.js')) {
        ...
        const changes = [];
        const sourceNodes = (0, ast_utils_1.getSourceNodes)(sourceFile);
        ...
        (0, workspace_1.insert)(host, 'jest.config.js', changes);
    }
}
