...
function projectsToRun(nxArgs, projectGraph) {
    let affectedGraph = nxArgs.all
        ? projectGraph
        : (0, affected_project_graph_1.filterAffected)(projectGraph, (0, file_utils_1.calculateFileChanges)((0, shared_1.parseFiles)(nxArgs).files, projectGraph.allWorkspaceFiles, nxArgs));
    if (!nxArgs.all && nxArgs.withDeps) {
        affectedGraph = (0, project_graph_1.withDeps)(projectGraph, Object.values(affectedGraph.nodes));
    }
    if (nxArgs.exclude) {
