...
function updateTsConfig(host) {
    ...
    (0, devkit_1.writeJson)(host, 'tsconfig.base.json', setUpCompilerOptions((0, devkit_1.readJson)(host, getRootTsConfigPath(host))));
...
function updateTsConfigsJson(host, options) {
    ...
    if (!!e2eProject) {
        (0, devkit_1.updateJson)(host, e2eProject.targets.lint.options.tsConfig, (json) => {
...
function moveExistingFiles(host, options) {
    ...
    if (e2eApp) {
        ...
        const newE2eRoot = (0, devkit_1.joinPathFragments)('apps', `${getE2eKey(host)}-e2e`);
...
function checkCanConvertToWorkspace(host) {
    try {
        ...
        if (e2eApp &&
            ...
            throw new Error(`An e2e project was specified but ${e2eApp.targets.e2e.options.protractorConfig} could not be found.`);
        }
        return host;
    }
    catch (e) {
...
function initGenerator(tree, schema) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        if (schema.preserveAngularCLILayout) {
            (0, devkit_1.addDependenciesToPackageJson)(tree, {}, { '@nrwl/workspace': versions_1.nxVersion });
            createNxJson(tree);
