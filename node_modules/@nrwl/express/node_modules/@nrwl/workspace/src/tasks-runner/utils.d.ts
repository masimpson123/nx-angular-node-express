import { ProjectGraph, ProjectGraphProjectNode, TargetDependencyConfig, Task, TaskGraph } from '@nrwl/devkit';
...
export declare function shouldForwardOutput(task: Task, initiatingProject: string | null, options: {
