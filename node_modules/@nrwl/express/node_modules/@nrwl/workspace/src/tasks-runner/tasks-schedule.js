...
class TasksSchedule {
    constructor(hasher, taskGraph, workspace, options) {
        this.hasher = hasher;
    ...
    scheduleBatches() {
        ...
        for (const root of this.notScheduledTaskGraph.roots) {
            ...
            const executorName = (0, utils_1.getExecutorNameForTask)(rootTask, this.workspace);
    ...
    processTaskForBatches(batches, task, rootExecutorName, isRoot) {
        var _a;
        const { batchImplementationFactory } = (0, utils_1.getExecutorForTask)(task, this.workspace);
        const executorName = (0, utils_1.getExecutorNameForTask)(task, this.workspace);
    ...
    hashTask(task) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            const customHasher = (0, utils_1.getCustomHasher)(task, this.workspace);
