...
function sortTsConfig(tree) {
    try {
        const tsconfig = (0, json_1.readJson)(tree, 'tsconfig.base.json');
        const sortedPaths = (0, object_sort_1.sortObjectByKeys)(tsconfig.compilerOptions.paths);
        (0, json_1.writeJson)(tree, 'tsconfig.base.json', Object.assign(Object.assign({}, tsconfig), { compilerOptions: Object.assign(Object.assign({}, tsconfig.compilerOptions), { paths: sortedPaths }) }));
    }
    catch (e) {
        // catch noop
    }
