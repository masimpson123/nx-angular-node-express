...
function updateWorkspaceJsonToMatchFormatVersion(host) {
    const workspaceConfigPath = (0, workspace_1.workspaceConfigName)(app_root_1.appRootPath);
    try {
        if (workspaceConfigPath) {
            const workspaceJson = (0, devkit_1.parseJson)(host.read(workspaceConfigPath).toString());
            const reformatted = (0, workspace_1.reformattedWorkspaceJsonOrNull)(workspaceJson);
            if (reformatted) {
                host.overwrite(workspaceConfigPath, (0, devkit_1.serializeJson)(reformatted));
            }
        }
    }
    catch (e) {
