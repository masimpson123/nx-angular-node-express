...
class Rule extends Lint.Rules.AbstractRule {
    constructor(options, projectPath, npmScope, projectGraph, targetProjectLocator, workspaceLayout) {
        super(options);
        ...
        if (!projectPath) {
            this.projectPath = (0, path_1.normalize)(app_root_1.appRootPath);
    ...
    apply(sourceFile) {
        if (!this.projectGraph)
            return [];
        return this.applyWithWalker(new EnforceModuleBoundariesWalker(sourceFile, this.getOptions(), this.projectPath, this.npmScope, this.projectGraph, this.targetProjectLocator, this.workspaceLayout));
    }
}
exports.Rule = Rule;
class EnforceModuleBoundariesWalker extends Lint.RuleWalker {
    constructor(sourceFile, options, projectPath, npmScope, projectGraph, targetProjectLocator, workspaceLayout) {
    ...
    visitImportDeclaration(node) {
        ...
        if ((0, runtime_lint_utils_1.isRelativeImportIntoAnotherProject)(imp, this.projectPath, this.projectGraph, filePath, sourceProject) ||
        ...
        const targetProject = (0, runtime_lint_utils_1.findProjectUsingImport)(this.projectGraph, this.targetProjectLocator, filePath, imp, this.npmScope);
        ...
        if (sourceProject === targetProject) {
            if (!this.allowCircularSelfDependency && !(0, fileutils_1.isRelativePath)(imp)) {
