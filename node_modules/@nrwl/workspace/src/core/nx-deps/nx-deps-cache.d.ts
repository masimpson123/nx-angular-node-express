import type { FileData, NxJsonConfiguration, ProjectFileMap, ProjectGraph, ProjectGraphDependency, ProjectGraphNode, ProjectGraphExternalNode, WorkspaceJsonConfiguration } from '@nrwl/devkit';
...
export declare function createCache(nxJson: NxJsonConfiguration<'*' | string[]>, packageJsonDeps: Record<string, string>, projectGraph: ProjectGraph<any>, tsConfig: {
    compilerOptions?: {
        paths?: {
            [p: string]: any;
        };
