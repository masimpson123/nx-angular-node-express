...
function jsPluginConfig(nxJson) {
    if (nxJson &&
        nxJson &&
        (nxJson === null || nxJson === void 0 ? void 0 : nxJson.pluginsConfig) &&
        (nxJson === null || nxJson === void 0 ? void 0 : nxJson.pluginsConfig['@nrwl/js'])) {
        return nxJson === null || nxJson === void 0 ? void 0 : nxJson.pluginsConfig['@nrwl/js'];
    }
    else {
        return {};
    }
...
function readRootTsConfig() {
    for (const tsConfigName of ['tsconfig.base.json', 'tsconfig.json']) {
        const tsConfigPath = (0, path_1.join)(app_root_1.appRootPath, tsConfigName);
