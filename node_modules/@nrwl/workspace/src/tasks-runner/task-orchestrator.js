...
class TaskOrchestrator {
    ...
    constructor(hasher, initiatingProject, projectGraph, taskGraph, options) {
        ...
        this.tasksSchedule = new tasks_schedule_1.TasksSchedule(this.hasher, this.taskGraph, this.workspace, this.options);
    ...
    runTaskInForkedProcess(task) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            try {
                ...
                const forwardOutput = (0, utils_1.shouldForwardOutput)(task, this.initiatingProject, this.options);
    ...
    postRunSteps(results, { groupId }) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            yield Promise.all(results
                ...
                .map(({ task, code, terminalOutput, outputs }) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
