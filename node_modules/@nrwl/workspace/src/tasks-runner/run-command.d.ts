...
import type { NxJsonConfiguration, ProjectGraph, ProjectGraphNode, TargetDependencyConfig, Task } from '@nrwl/devkit';
import { Environment } from '../core/shared-interfaces';
import { NxArgs } from '../command-line/utils';
export declare function runCommand(projectsToRun: ProjectGraphNode[], projectGraph: ProjectGraph, { nxJson }: Environment, nxArgs: NxArgs, overrides: any, terminalOutputStrategy: 'default' | 'hide-cached-output' | 'run-one', initiatingProject: string | null): Promise<void>;
