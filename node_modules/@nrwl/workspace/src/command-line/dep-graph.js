...
function generateGraph(args, affectedProjects) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        let graph = (0, project_graph_1.pruneExternalNodes)(yield (0, project_graph_1.createProjectGraphAsync)());
        ...
        let html = (0, fs_1.readFileSync)((0, path_2.join)(__dirname, '../core/dep-graph/index.html'), 'utf-8');
        graph = filterGraph(graph, args.focus || null, args.exclude || []);
        if (args.file) {
            const workspaceFolder = app_root_1.appRootPath;
            const ext = (0, path_2.extname)(args.file);
            const fullFilePath = (0, path_2.isAbsolute)(args.file)
                ? args.file
                : (0, path_2.join)(workspaceFolder, args.file);
            const fileFolderPath = (0, path_2.dirname)(fullFilePath);
            if (ext === '.html') {
                const assetsFolder = (0, path_2.join)(fileFolderPath, 'static');
                const assets = [];
                (0, fs_extra_1.copySync)((0, path_2.join)(__dirname, '../core/dep-graph'), assetsFolder, {
                    filter: (_src, dest) => {
                ...
                (0, fs_1.writeFileSync)((0, path_2.join)(assetsFolder, 'environment.js'), environmentJs);
                ...
                (0, fs_extra_1.ensureDirSync)((0, path_2.dirname)(fullFilePath));
                (0, devkit_1.writeJsonFile)(fullFilePath, {
                    graph,
                    affectedProjects,
...
function startServer(html, environmentJs, host, port = 4211, watchForchanges = false, affected = [], focus = null, groupByFolder = false, exclude = [], openBrowser = true) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const app = http.createServer((req, res) => {
            ...
            const sanitizePath = (0, path_2.basename)(parsedUrl.pathname);
            ...
            let pathname = (0, path_2.join)(__dirname, '../core/dep-graph/', sanitizePath);
            ...
            try {
                ...
                const ext = (0, path_2.parse)(pathname).ext;
...
function startWatcher() {
    createFileWatcher(app_root_1.appRootPath, () => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
...
function createFileWatcher(root, changeHandler) {
    ...
    const watcher = (0, chokidar_1.watch)([
        (0, path_1.joinPathFragments)(layout.appsDir, '**'),
        (0, path_1.joinPathFragments)(layout.libsDir, '**'),
    ], {
        cwd: root,
        ignoreInitial: true,
    });
    watcher.on('all', debounce((event, path) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
