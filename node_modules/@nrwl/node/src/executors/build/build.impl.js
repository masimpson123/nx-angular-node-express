...
function buildExecutor(rawOptions, context) {
    return (0, tslib_1.__asyncGenerator)(this, arguments, function* buildExecutor_1() {
        ...
        }, (0, node_config_1.getNodeWebpackConfig)(options));
        return yield (0, tslib_1.__await)(yield (0, tslib_1.__await)(yield* (0, tslib_1.__asyncDelegator)((0, tslib_1.__asyncValues)((0, rxjs_for_await_1.eachValueFrom)((0, run_webpack_1.runWebpack)(config).pipe((0, operators_1.tap)((stats) => {
...
function registerTsNode() {
    const rootTsConfig = (0, path_1.join)(app_root_1.appRootPath, 'tsconfig.base.json');
    (0, ts_node_1.register)(Object.assign({}, ((0, fs_1.existsSync)(rootTsConfig) ? { project: rootTsConfig } : null)));
}
