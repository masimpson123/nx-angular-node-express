...
export declare function hasNoneOfTheseTags(proj: ProjectGraphProjectNode<any>, tags: string[]): boolean;
...
export declare function isRelativeImportIntoAnotherProject(imp: string, projectPath: string, projectGraph: MappedProjectGraph, sourceFilePath: string, sourceProject: ProjectGraphProjectNode): boolean;
...
export declare function findProjectUsingImport(projectGraph: ProjectGraph, targetProjectLocator: TargetProjectLocator, filePath: string, imp: string, npmScope: string): ProjectGraphExternalNode | ProjectGraphProjectNode<any>;
