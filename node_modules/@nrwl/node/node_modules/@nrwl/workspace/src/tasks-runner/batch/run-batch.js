...
function getBatchExecutor(executorName) {
    const workspace = new workspace_1.Workspaces(app_root_1.appRootPath);
...
process.on('message', (message) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
    switch (message.type) {
