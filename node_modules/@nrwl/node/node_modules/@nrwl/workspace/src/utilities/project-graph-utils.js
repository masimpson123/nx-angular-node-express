...
const package_json_1 = require("@nrwl/tao/src/shared/package-json");
...
function mergeNpmScriptsWithTargets(projectRoot, targets) {
    try {
        const { scripts, nx } = (0, devkit_1.readJsonFile)((0, path_1.join)(projectRoot, 'package.json'));
        const res = {};
        // handle no scripts
...
function getProjectNameFromDirPath(projRelativeDirPath, projectGraph = (0, project_graph_1.readCachedProjectGraph)()) {
    ...
    for (const [nodeName, node] of Object.entries(projectGraph.nodes)) {
        const normalizedRootPath = (0, devkit_1.normalizePath)(node.data.root);
        const normalizedProjRelPath = (0, devkit_1.normalizePath)(projRelativeDirPath);
