...
function startInBackground() {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        const backgroundProcess = (0, child_process_1.spawn)(process.execPath, ['../server/start.js'], {
            cwd: __dirname,
        ...
        return new Promise((resolve, reject) => {
            const id = setInterval(() => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
...
function startInCurrentProcess() {
    ...
    (0, child_process_1.spawnSync)(process.execPath, ['../server/start.js'], {
        cwd: __dirname,
        stdio: 'inherit',
    });
}
