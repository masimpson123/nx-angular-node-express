...
class Hasher {
    ...
    runtimeInputsHash() {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            this.runtimeInputs = new Promise((res, rej) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                const fileHashes = [
                    ...fileNames
                        ...
                        if (!maybeRelativePath.startsWith(app_root_1.appRootPath)) {
                            return (0, path_1.join)(app_root_1.appRootPath, maybeRelativePath);
                        }
    ...
    hashNxJson() {
        const nxJsonPath = (0, path_1.join)(app_root_1.appRootPath, 'nx.json');
...
class ProjectHasher {
    ...
    hashProject(projectName, visited) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            return Promise.resolve().then(() => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                var _a;
                const deps = (_a = this.projectGraph.dependencies[projectName]) !== null && _a !== void 0 ? _a : [];
                const depHashes = (yield Promise.all(deps.map((d) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
    ...
    hashProjectNodeSource(projectName) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            if (!this.sourceHashes[projectName]) {
                this.sourceHashes[projectName] = new Promise((res) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                    var _a, _b;
    ...
    removeOtherProjectsPathRecords(projectName) {
        var _a;
        const _b = this.tsConfigJson.compilerOptions, { paths } = _b, compilerOptions = (0, tslib_1.__rest)(_b, ["paths"]);
    ...
    readTsConfig() {
        ...
        var _b;
        try {
            const res = (0, devkit_1.readJsonFile)('tsconfig.base.json');
    ...
    readWorkspaceConfigFile(path) {
        var _a;
        try {
            const res = (0, devkit_1.readJsonFile)(path);
            (_a = res.projects) !== null && _a !== void 0 ? _a : (res.projects = {});
            return (0, workspace_1.resolveNewFormatWithInlineProjects)(res);
        }
        catch (_b) {
