...
function createFiles(host, options) {
    (0, devkit_1.generateFiles)(host, path.join(__dirname, '../files/lib'), options.projectRoot, Object.assign(Object.assign({}, options), { offsetFromRoot: (0, devkit_1.offsetFromRoot)(options.projectRoot), tpl: '' }));
}
function fixProjectWorkspaceConfig(host, options) {
    ...
    const fixedProject = (0, workspace_1.replaceAppNameWithPath)(project, options.name, options.projectRoot);
    if (!options.publishable && !options.buildable) {
