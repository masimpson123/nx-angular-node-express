...
function applicationGenerator(host, schema) {
    return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        (0, lib_1.createFiles)(host, options, appProjectRoot);
        (0, devkit_1.moveFilesToNewDirectory)(host, appProjectRoot, options.appProjectRoot);
        ...
        yield (0, lib_1.addE2e)(host, options, e2eProjectRoot);
